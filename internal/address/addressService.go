...
var (
    ErrAddressUserIDInvalid = errors.New("address user id is empty or negative")
    ErrAddressStreetEmpty = errors.New("address street is empty")
    ErrAddressStreetInvalid = errors.New("address street must be between 3-100 characters")
    ErrAddressNumberEmpty = errors.New("address number is empty")
    ErrAddressNumberInvalid = errors.New("address number must contain digits in range 0-9")
    ErrAddressCEPEmpty = errors.New("address cep is empty")
    ErrAddressCEPInvalid = errors.New("address cep must must contain digits in range 0-9")
    ErrAddressNeighborhoodEmpty = errors.New("address neighborhood is empty")
    ErrAddressNeighborhoodInvalid = errors.New("address neighborhood must be between 3-100 characters")
    ErrAddressCityEmpty = errors.New("address city is empty")
    ErrAddressCityInvalid = errors.New("address city must be between 3-100 characters")
    ErrAddressStateEmpty = errors.New("address state is empty")
    ErrAddressStateInvalid = errors.New("address state must contain only 2 characters, example: RS, SP, RJ")
)
